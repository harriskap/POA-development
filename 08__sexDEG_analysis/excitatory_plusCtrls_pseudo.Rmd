---
title: "Excitatory + ctrls pseudobulk sex differences"
author: "Noor Sohail"
date: "`r Sys.Date()`"
output:
   html_document:
...
```{r echo=FALSE}
filename <- "../data/excit_merge_noNA_plusCtrls.RDS"
